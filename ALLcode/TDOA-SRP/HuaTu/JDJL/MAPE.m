...
% 设置图表标题和标签
title('MAPE', 'FontSize', 14, 'FontWeight', 'bold');  % 设置标题字体大小
xlabel('Data(1-26)', 'FontSize', 12);  % 设置横坐标标签字体大小
ylabel('', 'FontSize', 12);  % 设置纵坐标标签字体大小
...
% 显示图例，并调整位置，设置字体大小
legend({'GCC-PHAT', 'Improved GCC-PHAT'}, 'Location', 'northeast', 'FontSize', 12);  % 设置图例字体大小
...
% 保存为高分辨率图片
exportgraphics(gcf, 'GCC_PHAT_MAPE_bar.png', 'Resolution', 300);
